...
# def on_speech_recognized(target, event):
#     transcript = event.new
#     # Send the recognized speech as text to the chat interface
#     chat_interface.send(transcript, user="User", respond=False)

# # Link the speech recognition widget to the callback function
# speech_input.link(speech_input, callbacks={"value": on_speech_recognized})

# # Create a Panel layout with the speech recognition widget
# speech_panel = pn.Column(
#     speech_input,
